...
public class CartPage {
    ...
    private String itemPrice_txt = "//div[text()='%s']/parent::a/parent::div//div[@class='inventory_item_price']";

    // using id for creating locator for checkout button
    private String checkout_btn = "//div[@class='cart_footer']/a[2]";
    ...
    public Locator loc_checkoutBtn(){
        return generic.getByLocator(checkout_btn);
//        return generic.getById(checkout_btn);
    ...
    public String getItemPrice(String itemName){
        String itemPrice = generic.getInnerText(loc_itemPrice(itemName));
