...
public class CheckoutPage {
    ...
    private String checkoutInfo_txt = "//div[@class='subheader']"; //xpath for getting "Checkout: Your Information"  text
    ...
    private String continue_btn = "//div[@class='checkout_buttons']/input"; // id continue button
    ...
    private String totalPrice_txt = ".summary_total_label"; //css selector for getting the final total price including tax
    private String finist_btn = "//div[@class='cart_footer']/a[2]"; //id for finish  button
    ...
    public Locator loc_getContinueButton(){
        return generic.getByLocator(continue_btn);
//        return generic.getById(continue_btn);
    ...
    public Locator loc_finishButton(){
        return generic.getByLocator(finist_btn);
