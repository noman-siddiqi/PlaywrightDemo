...
public class BuyProduct {
    ...
    public void test_Successful_Checkout() {
        ...
        //Calculate total product cost (Using substring(1) to get substring without $ symbol)
        ...
        softAssert.assertEquals(cartPage.getNameOfAllItemsInCart().containsAll(Arrays.asList("Sauce Labs Backpack","Sauce Labs Bike Light")),true,"[Failed]: Items in cart does not match");
        ...
        softAssert.assertEquals(cartPage.getNameOfAllItemsInCart().containsAll(Arrays.asList("Sauce Labs Backpack","Sauce Labs Bike Light")),true,"[Failed]: Items on checkout page does not match");
        softAssert.assertEquals(cartPage.getItemPrice("Sauce Labs Backpack"),backpackPrice, "[Failed]: Sauce Labs Backpack price does not match in cart");
        softAssert.assertEquals(cartPage.getItemPrice("Sauce Labs Bike Light"),bikeLightPrice, "[Failed]: Sauce Labs Bike Light price does not match in cart");
